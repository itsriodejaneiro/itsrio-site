...
class ET_Builder_Module_Blog_CUSTOMIZADO extends ET_Builder_Module {
	function init() {
		$this->name       = esc_html__( '1. COMPONENTE CUSTOMIZADO', 'et_builder_customizado' );
	...
	function get_fields() {
		$fields = array(
			...
			'__posts' => array(
				'type' => 'computed',
				'computed_callback' => array( 'ET_Builder_Module_Blog_CUSTOMIZADO', 'get_blog_posts' ),
...
new ET_Builder_Module_Blog_CUSTOMIZADO;
