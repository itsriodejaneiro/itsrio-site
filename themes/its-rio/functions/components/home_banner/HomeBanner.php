...
class HomeBanner extends ET_Builder_Module {

	function init() {
		$this->name = esc_html__( 'Home ITS - Banner', 'et_builder' );
		$this->slug = 'et_pb_home_banner';
	...
	function get_fields() {
		$fields = array(
			'count' => array(
				'label'             => esc_html__( 'Limite de posts', 'et_builder' ),
				'type'              => 'text',
