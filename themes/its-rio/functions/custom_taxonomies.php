...
function custom_taxonomy(){
    register_custom_taxonomy('videos_cat', 'videos_ctp', 'Categoria de vídeo', 'Categoria de vídeos', "Categorias de vídeos");
    register_custom_taxonomy('artigos_cat', 'artigos_ctp', 'Categoria de Artigo', 'Categoria de artigos', "Categorias de artigos");
    register_custom_taxonomy('publicacoes_cat', 'publicacoes_ctp', 'Categoria de publicação', 'Categoria de publicações', "Categorias de publicações");
    register_custom_taxonomy('comunicados_cat', 'comunicados_ctp', 'Categoria de comunicado', 'Categorias de comunicados', "Categorias de comunicados");
}
